...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 breadcrumb-wrapper mb-4"><span class="text-muted fw-light">Anagrafica /</span> Fornitori</h4>
        {{-- 'fornitori' deve diventare variabile  --}}
                ...
                <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                    <div class="card-header flex-column flex-md-row">
                        <div class="head-label text-center">
                            <h5 class="card-title mb-0">Lista fornitori</h5> {{-- 'dipendendi' deve diventare variabile  --}}
                        </div>
                            ...
                            <tr class="odd">
                                ...
                                <td valign="top" class="dataTables_empty">
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        <a href="{{ route('admin.providers.show', 1) }}"><button type="button"
